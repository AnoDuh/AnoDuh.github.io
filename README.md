HTML, CSS ve JS ile yazıldı, istediğiniz gibi kullanın. Sesler için 11 labs diye bir siteyi kullandım (voice model= gönül). Modeller için ise blender'ı kullandım. 
